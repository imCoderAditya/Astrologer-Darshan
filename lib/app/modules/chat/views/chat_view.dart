        ...
        children: [
          Hero(
            ...
            child: CircleAvatar(
              ...
              child: ClipOval(
                child:
                    widget.sessionData?.customer?.profilePicture?.isNotEmpty ??
                            false
                        ? Image.network(
                          widget.sessionData?.customer?.profilePicture ?? "",
                          fit: BoxFit.cover,
                          width: 40.r,
                          height: 40.r,
                          errorBuilder: (context, error, stackTrace) {
                            ...
                            return Center(
                              child: Text(
                                _getInitials(
                                  "${widget.sessionData?.customer?.firstName ?? ""} ${widget.sessionData?.customer?.lastName ?? ""}",
                                ),
                                style: TextStyle(
                                  fontSize: 14.sp,
